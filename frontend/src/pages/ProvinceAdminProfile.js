...
const ProvinceAdminProfile = () => {
  ...
  // Get assigned region and province names (if populated, else show ID)
  const regionName =
    userDetails.address &&
...
export default ProvinceAdminProfile;